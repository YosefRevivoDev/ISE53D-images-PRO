...
//wallSpheres
        ...
        scene1.lights.add(new SpotLight(new Vector(0,-1,0),new Color(java.awt.Color.orange), new Point(-56, 50, 71),3));
        scene1.lights.add(new SpotLight(new Vector(1.5,-1,0),new Color(java.awt.Color.CYAN).scale(0.8), new Point(10, 55, 75),3));

        ImageWriter imageWriter = new ImageWriter("99999", 1000, 1000);
